 ...
 */
public class SnapHashMap1<K,V> extends AbstractMap<K,V> implements ConcurrentMap<K,V>, Cloneable, Serializable {
    ...
    public SnapHashMap1(final Map<? extends K, ? extends V> source) {
        this.rootHolder = new COWMgr<K,V>();
        putAll(source);
    }

    public SnapHashMap1(final SortedMap<K,? extends V> source) {
        if (source instanceof SnapHashMap1) {
            final SnapHashMap1<K,V> s = (SnapHashMap1<K,V>) source;
    ...
    @SuppressWarnings("unchecked")
    @Override
    public SnapHashMap1<K,V> clone() {
        final SnapHashMap1<K,V> copy;
        try {
            copy = (SnapHashMap1<K,V>) super.clone();
    ...
    class KeySet extends AbstractSet<K> {
        ...
        public boolean isEmpty() {
            return SnapHashMap1.this.isEmpty();
        }
        public int size() {
            return SnapHashMap1.this.size();
        }
        public boolean contains(Object o) {
            return SnapHashMap1.this.containsKey(o);
        }
        public boolean remove(Object o) {
            return SnapHashMap1.this.remove(o) != null;
        }
        public void clear() {
            SnapHashMap1.this.clear();
        }
    }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public boolean contains(Object o) {
            return SnapHashMap1.this.containsValue(o);
        }
        public void clear() {
            SnapHashMap1.this.clear();
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K,V>> {
        ...
        public boolean contains(Object o) {
            if (!(o instanceof Entry))
                return false;
            Entry<?,?> e = (Entry<?,?>)o;
            V v = SnapHashMap1.this.get(e.getKey());
        ...
        public boolean remove(Object o) {
            if (!(o instanceof Entry))
                return false;
            Entry<?,?> e = (Entry<?,?>)o;
            return SnapHashMap1.this.remove(e.getKey(), e.getValue());
        }
        public boolean isEmpty() {
            return SnapHashMap1.this.isEmpty();
        }
    ...
    abstract class AbstractIter {
        ...
        public void remove() {
            ...
            SnapHashMap1.this.remove(prevEntry.key);
            prevEntry = null;
        }
    }
	...
	public V setValue(final V value) {
            ...
            SnapHashMap1.this.put(getKey(), value);
            return prev;
        }
    }
